...
namespace UniversalItemManagement.EF.Migrations
{
    ...
    [Migration("20260228210914_AddNumberAndSelectFieldTypes")]
    partial class AddNumberAndSelectFieldTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UniversalItemManagement.EF.Domain.Models.Entities.Record", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9bfe86c3-3d9e-4620-b971-c98164d68021"),
                            CreatedOn = new DateTime(2026, 2, 28, 21, 9, 14, 58, DateTimeKind.Utc).AddTicks(9159),
                            Description = "Bla",
                            ModifiedOn = new DateTime(2026, 2, 28, 21, 9, 14, 58, DateTimeKind.Utc).AddTicks(9321),
                            Name = "Test"
                        });
                });
            ...
            modelBuilder.Entity("UniversalItemManagement.EF.Domain.Models.Entities.Fields.FieldValue", b =>
                {
                    ...
                    b.HasOne("UniversalItemManagement.EF.Domain.Models.Entities.Fields.SelectOption", "SelectOption")
                        .WithMany()
