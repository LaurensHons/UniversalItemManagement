...
- Create Angular project with ng: `ng new universalitemmanagement.client --defaults --skip-install --skip-git `.
...
- Create project file (`universalitemmanagement.client.esproj`).
